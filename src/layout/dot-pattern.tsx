...
export function DotPattern({
	...
	return (
		<div
			ref={containerRef}
			// 1. 🚀 CAMBIO: El contenedor ahora es fondo blanco nativo
			className={cn("fixed inset-0 overflow-y-auto bg-white", className)}
		>
			{/* 2. 🎯 PARÁMETROS DE COLOR CLARO: Puntos grises suaves y brillo reactivo */}
			<canvas
				ref={canvasRef}
				className="pointer-events-none absolute inset-0 h-full w-full"
				data-base-color="#e4e4e7" // Puntos zinc suaves en reposo
				data-glow-color="#3b82f6" // Brillo azul estético al pasar el mouse (o #22d3ee)
			/>

			{/* 3. 🔄 AJUSTE DEL DEGRADADO: Cambiamos el viñeteado negro de los bordes por uno blanco/transparente */}
			<div
				className="pointer-events-none absolute inset-0"
				style={{
					background:
						"radial-gradient(ellipse at center, transparent 0%, transparent 60%, rgba(255,255,255,0.8) 100%)",
				}}
			/>

			{/* Capa de contenido donde flotan tus tarjetas intactas */}
